<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"D:\wwwroot\qiandao.com\public/../application/admin\view\plugin\index.html";i:1526287908;s:57:"D:\wwwroot\qiandao.com\application\admin\view\layout.html";i:1526119482;s:47:"../application/common/builder/aside/layout.html";i:1512640190;s:54:"../application/common/builder/aside/blocks/recent.html";i:1489042526;s:54:"../application/common/builder/aside/blocks/online.html";i:1489042526;s:54:"../application/common/builder/aside/blocks/switch.html";i:1489042526;}*/ ?>
<!DOCTYPE html>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="pull-right">
                        <ul class="block-options push-10-t push-10-r">
                            <li>
                                <a href="<?php echo url('index', ['type' => $type]); ?>"><i class="si si-<?php echo $type=='list'?'list' : 'grid'; ?>"></i></a>
                            </li>
                            <li>
                            ...
                            <div class="col-md-12">
                                <div class="pull-right search-bar">
                                    <form class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo input('get.keyword'); ?>" name="keyword" placeholder="请输入标识/名称/作者">
                                    </form>
                                </div>

                                <div class="toolbar-btn-action">
                                    <a title="全部" class="btn btn-default" href="<?php echo url('index'); ?>">全部(<?php echo (isset($total['all']) && ($total['all'] !== '')?$total['all']:'0'); ?>)</a>
                                    <a title="已启用" class="btn btn-success" href="<?php echo url('index', ['status' => '1']); ?>">已启用(<?php echo (isset($total['1']) && ($total['1'] !== '')?$total['1']:'0'); ?>)</a>
                                    <a title="已禁用" class="btn btn-warning" href="<?php echo url('index', ['status' => '0']); ?>">已禁用(<?php echo (isset($total['0']) && ($total['0'] !== '')?$total['0']:'0'); ?>)</a>
                                    <a title="未安装" class="btn btn-info" href="<?php echo url('index', ['status' => '-1']); ?>">未安装(<?php echo (isset($total['-1']) && ($total['-1'] !== '')?$total['-1']:'0'); ?>)</a>
                                    <a title="已损坏" class="btn btn-danger" href="<?php echo url('index', ['status' => '-2']); ?>" id="hide_disable">已损坏(<?php echo (isset($total['-2']) && ($total['-2'] !== '')?$total['-2']:'0'); ?>)</a>
                                </div>
                            </div>
                        </div>
                        <div class="row module-list push-20">
                            <?php if(empty($plugins) || (($plugins instanceof \think\Collection || $plugins instanceof \think\Paginator ) && $plugins->isEmpty())): ?>
                            <div class="table-empty">
                                <div class="text-center empty-info">
                                    <i class="fa fa-database"></i> 暂无数据<br>
                                </div>
                            </div>
                            <?php endif; if($type == 'block'): if(is_array($plugins) || $plugins instanceof \think\Collection || $plugins instanceof \think\Paginator): $i = 0; $__LIST__ = $plugins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$plugin): $mod = ($i % 2 );++$i;?>
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="block block-rounded">
                                    <div class="block-content block-content-full text-center bg-<?php echo (isset($plugin['bg_color']) && ($plugin['bg_color'] !== '')?$plugin['bg_color']:'danger'); ?> ribbon ribbon-bookmark ribbon-crystal">
                                        <div class="ribbon-box font-w600"><?php echo (isset($plugin['version']) && ($plugin['version'] !== '')?$plugin['version']:'无版本号'); ?></div>
                                        <div class="item item-2x item-circle bg-crystal-op push-20-t push-20 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                                            <i class="<?php echo (isset($plugin['icon']) && ($plugin['icon'] !== '')?$plugin['icon']:'fa fa-puzzle-piece'); ?> text-white-op"></i>
                                        </div>
                                        <h3 class="h4 text-white"><?php echo (isset($plugin['title']) && ($plugin['title'] !== '')?$plugin['title']:'无插件标题'); ?></h3>
                                        <div class="text-white-op">
                                            <em><?php echo (isset($plugin['name']) && ($plugin['name'] !== '')?$plugin['name']:''); ?></em>
                                        </div>
                                    </div>
                                    <div class="block-content bg-gray-lighter">
                                        <div class="<?php echo $plugin['status_class']; ?> pull-right push-10-l"><?php echo $plugin['status_info']; ?></div>
                                        <div class="push-10">
                                            <a class="h5" href="<?php echo (isset($plugin['author_url']) && ($plugin['author_url'] !== '')?$plugin['author_url']:''); ?>" target="_blank"><i class="fa fa-user"></i> <?php echo (isset($plugin['author']) && ($plugin['author'] !== '')?$plugin['author']:''); ?></a>
                                        </div>
                                        <div class="push-10 mheight-100">
                                            <div data-toggle="slimscroll" data-height="110px">
                                                <p class="text-gray-dark"><?php echo (isset($plugin['description']) && ($plugin['description'] !== '')?$plugin['description']:'暂无简介'); ?></p>
                                            </div>
                                        </div>
                                        <div class="text-center push">
                                            <?php echo $plugin['actions']; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; endif; else: echo "" ;endif; else: if(!(empty($plugins) || (($plugins instanceof \think\Collection || $plugins instanceof \think\Paginator ) && $plugins->isEmpty()))): ?>
                                <div class="col-md-12">
                                    <div class="builder-table-wrapper" id="builder-table-wrapper">
                                        <div class="builder-table" id="builder-table">
                                            <table class="table table-builder table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                <?php if(is_array($plugins) || $plugins instanceof \think\Collection || $plugins instanceof \think\Paginator): $i = 0; $__LIST__ = $plugins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$plugin): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td><?php echo (isset($plugin['title']) && ($plugin['title'] !== '')?$plugin['title']:'无插件标题'); ?></td>
                                                    <td><i class="<?php echo (isset($plugin['icon']) && ($plugin['icon'] !== '')?$plugin['icon']:'fa fa-puzzle-piece'); ?>"></i></td>
                                                    <td><?php echo (isset($plugin['version']) && ($plugin['version'] !== '')?$plugin['version']:'无版本号'); ?></td>
                                                    <td><a href="<?php echo (isset($plugin['author_url']) && ($plugin['author_url'] !== '')?$plugin['author_url']:''); ?>" target="_blank"><?php echo (isset($plugin['author']) && ($plugin['author'] !== '')?$plugin['author']:''); ?></a></td>
                                                    <td><?php echo (isset($plugin['description']) && ($plugin['description'] !== '')?$plugin['description']:'暂无简介'); ?></td>
                                                    <td><?php echo $plugin['actions']; ?></td>
                                                </tr>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </tbody>
                                            </table>
                        ...
                        <div class="data-table-toolbar">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php echo $pages; endif; if(!(empty($row_list) || (($row_list instanceof \think\Collection || $row_list instanceof \think\Paginator ) && $row_list->isEmpty()))): ?>
                                    <div class="pagination-info pull-right">
                                        <form action="" method="get">
                                            <input type="text" class="form-control input-sm go-page" name="page" value="<?php echo input('param.page', '1'); ?>">
                                            <input type="text" class="form-control input-sm nums" name="list_rows" value="<?php echo input('param.list_rows', '') == '' ? config('list_rows') : input('param.list_rows'); ?>">
                                            <input type="submit" class="hidden">
                                            / <strong><?php echo $row_list->lastPage(); ?></strong> 页，共 <strong><?php echo $row_list->total(); ?></strong> 条数据，每页显示数量
                                        </form>
                                    </div>
                                    <?php endif; ?>
                                </div>
