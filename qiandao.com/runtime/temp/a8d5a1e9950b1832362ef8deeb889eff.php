<?php if (!defined('THINK_PATH')) exit(); /*a:48:{s:76:"D:\wwwroot\qiandao.com\public/../application/common/builder/form/layout.html";i:1522143982;s:67:"D:\wwwroot\qiandao.com\public/../application/admin/view/layout.html";i:1526119482;s:47:"../application/common/builder/aside/layout.html";i:1512640190;s:54:"../application/common/builder/aside/blocks/recent.html";i:1489042526;s:54:"../application/common/builder/aside/blocks/online.html";i:1489042526;s:54:"../application/common/builder/aside/blocks/switch.html";i:1489042526;s:53:"../application/common/builder/form/items/archive.html";i:1525873482;s:54:"../application/common/builder/form/items/archives.html";i:1525873496;s:50:"../application/common/builder/form/items/bmap.html";i:1525873510;s:52:"../application/common/builder/form/items/button.html";i:1525873522;s:54:"../application/common/builder/form/items/checkbox.html";i:1525873530;s:54:"../application/common/builder/form/items/ckeditor.html";i:1525873546;s:57:"../application/common/builder/form/items/colorpicker.html";i:1525873552;s:50:"../application/common/builder/form/items/date.html";i:1525873560;s:55:"../application/common/builder/form/items/daterange.html";i:1526287120;s:54:"../application/common/builder/form/items/datetime.html";i:1525873570;s:54:"../application/common/builder/form/items/editormd.html";i:1525873580;s:50:"../application/common/builder/form/items/file.html";i:1525873594;s:51:"../application/common/builder/form/items/files.html";i:1525873600;s:53:"../application/common/builder/form/items/gallery.html";i:1525873606;s:51:"../application/common/builder/form/items/group.html";i:1512640506;s:52:"../application/common/builder/form/items/hidden.html";i:1495847800;s:50:"../application/common/builder/form/items/icon.html";i:1525873632;s:51:"../application/common/builder/form/items/image.html";i:1525873638;s:52:"../application/common/builder/form/items/images.html";i:1525873642;s:51:"../application/common/builder/form/items/jcrop.html";i:1525873646;s:53:"../application/common/builder/form/items/linkage.html";i:1525873652;s:54:"../application/common/builder/form/items/linkages.html";i:1525873664;s:52:"../application/common/builder/form/items/masked.html";i:1525873668;s:52:"../application/common/builder/form/items/number.html";i:1525873674;s:54:"../application/common/builder/form/items/password.html";i:1525873680;s:51:"../application/common/builder/form/items/radio.html";i:1525873684;s:51:"../application/common/builder/form/items/range.html";i:1525873690;s:52:"../application/common/builder/form/items/select.html";i:1525873696;s:53:"../application/common/builder/form/items/select2.html";i:1525873702;s:50:"../application/common/builder/form/items/sort.html";i:1525873708;s:52:"../application/common/builder/form/items/static.html";i:1525873722;s:56:"../application/common/builder/form/items/summernote.html";i:1525873738;s:52:"../application/common/builder/form/items/switch.html";i:1525873744;s:50:"../application/common/builder/form/items/tags.html";i:1525873750;s:50:"../application/common/builder/form/items/text.html";i:1525680820;s:50:"../application/common/builder/form/items/time.html";i:1525873764;s:54:"../application/common/builder/form/items/textarea.html";i:1525873756;s:53:"../application/common/builder/form/items/ueditor.html";i:1525873772;s:56:"../application/common/builder/form/items/wangeditor.html";i:1525873776;s:47:"../application/common/builder/form/icon/fa.html";i:1489042526;s:47:"../application/common/builder/form/icon/gl.html";i:1489042526;s:47:"../application/common/builder/form/icon/sl.html";i:1489042526;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <?php if(!(empty($_css_files) || (($_css_files instanceof \think\Collection || $_css_files instanceof \think\Paginator ) && $_css_files->isEmpty()))): if(\think\Config::get('minify_status') == '1'): ?>
        ...
        <?php else: if(is_array($_css_files) || $_css_files instanceof \think\Collection || $_css_files instanceof \think\Paginator): $i = 0; $__LIST__ = $_css_files;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$css): $mod = ($i % 2 );++$i;?>
            <?php echo load_assets($css); endforeach; endif; else: echo "" ;endif; endif; endif; if(!(empty($_icons) || (($_icons instanceof \think\Collection || $_icons instanceof \think\Paginator ) && $_icons->isEmpty()))): if(is_array($_icons) || $_icons instanceof \think\Collection || $_icons instanceof \think\Paginator): $i = 0; $__LIST__ = $_icons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$icon): $mod = ($i % 2 );++$i;?>
        <link rel="stylesheet" href="<?php echo $icon['url']; ?>">
    ...
    <link rel="stylesheet" href="<?php echo $vo; ?>?v=<?php echo config('asset_version'); ?>">
    <?php endforeach; endif; else: echo "" ;endif; if(is_array($extend_css_list) || $extend_css_list instanceof \think\Collection || $extend_css_list instanceof \think\Paginator): $i = 0; $__LIST__ = $extend_css_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        <link rel="stylesheet" href="<?php echo $v; ?>?v=<?php echo config('asset_version'); ?>">
        ...
        <ul class="nav-users remove-margin-b">
            ...
            <li>
                <a href="<?php echo (isset($vo['link']) && ($vo['link'] !== '')?$vo['link']:'javascript:void(0);'); ?>">
                    <img class="img-avatar" src="<?php echo (isset($vo['avatar']) && ($vo['avatar'] !== '')?$vo['avatar']:'/static/admin/img/avatar.jpg'); ?>" alt="">
...
<!-- END Side Content -->
                            ...
                            <form class="form-builder row" name="form-builder" action="<?php echo (isset($post_url) && ($post_url !== '')?$post_url:''); ?>" method="<?php echo $_method; ?>">
                                <?php if(empty($form_items) || (($form_items instanceof \think\Collection || $form_items instanceof \think\Paginator ) && $form_items->isEmpty())): if(!(empty($empty_tips) || (($empty_tips instanceof \think\Collection || $empty_tips instanceof \think\Paginator ) && $empty_tips->isEmpty()))): ?>
                                    ...
                                    <?php endif; else: if(is_array($form_items) || $form_items instanceof \think\Collection || $form_items instanceof \think\Paginator): $i = 0; $__LIST__ = $form_items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form): $mod = ($i % 2 );++$i;switch($form['type']): case "archive": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo (isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12'); ?> <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" id="form_group_<?php echo $form['name']; ?>">
    ...
    <div class="col-sm-12">
        <ul class="list-group uploader-list" id="file_list_<?php echo $form['name']; ?>">
            ...
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo get_file_name($form['value']); ?> [<a
                    href="<?php echo get_file_path($form['value']); ?>" class="download-file">下载</a>]</li>
            <?php endif; ?>
        </ul>
    ...
    <div class="col-sm-12">
        <ul class="list-group uploader-list" id="file_list_<?php echo $form['name']; ?>">
            ...
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo get_file_name($vo); ?> [<a
                    href="<?php echo get_file_path($vo); ?>" class="download-file">下载</a>]</li>
            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
        </ul>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
                                            ...
                                            <?php break; case "bmap": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo (isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12'); ?> js-bmap <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" data-level="<?php echo $form['level']==''?12 : $form['level']; ?>" id="form_group_<?php echo $form['name']; ?>">
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12">
...
<script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=<?php echo (isset($form['ak']) && ($form['ak'] !== '')?$form['ak']:''); ?>"></script>
                                            <?php break; case "button": ?>
                                                
                                                <div class="form-group col-lg-<?php echo (isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12'); ?>" id="form_group_<?php echo $form['name']; ?>">
    ...
    <div class="col-md-12">
        ...
        <?php endif; ?>
                                            ...
                                            <?php break; case "daterange": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo (isset($_layout[$form['name_from']]['lg']) && ($_layout[$form['name_from']]['lg'] !== '')?$_layout[$form['name_from']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form['name_from']]['md']) && ($_layout[$form['name_from']]['md'] !== '')?$_layout[$form['name_from']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form['name_from']]['sm']) && ($_layout[$form['name_from']]['sm'] !== '')?$_layout[$form['name_from']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form['name_from']]['xs']) && ($_layout[$form['name_from']]['xs'] !== '')?$_layout[$form['name_from']]['xs']:'12'); ?> <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" id="form_group_<?php echo $form['id']; ?>">
    <label class="col-xs-12"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-md-12">
...
<div class="form-group col-lg-<?php echo (isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12'); ?> <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" id="form_group_<?php echo $form['name']; ?>">
    ...
    <div class="col-sm-12 js-upload-file">
        <ul class="list-group uploader-list" id="file_list_<?php echo $form['name']; ?>">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): ?>
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo get_file_name($form['value']); ?> [<a
                    href="<?php echo get_file_path($form['value']); ?>" class="download-file">下载</a>] [<a
    ...
    <div class="col-sm-12 js-upload-files">
        <ul class="list-group uploader-list" id="file_list_<?php echo $form['name']; ?>">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): if(is_array(explode(',',$form['value'])) || explode(',',$form['value']) instanceof \think\Collection || explode(',',$form['value']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$form['value']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo get_file_name($vo); ?> [<a
                        href="<?php echo get_file_path($vo); ?>" class="download-file">下载</a>] [<a
                        href="javascript:void(0);" class="remove-file" data-id="<?php echo $vo; ?>">删除</a>]</li>
                <?php endforeach; endif; else: echo "" ;endif; endif; ?>
        </ul>
    ...
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-xs-12">
        <div id="file_list_<?php echo $form['name']; ?>" class="gallery-list">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): if(is_array(explode(',',$form['value'])) || explode(',',$form['value']) instanceof \think\Collection || explode(',',$form['value']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$form['value']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="file-item thumbnail">
                <img data-original="<?php echo get_file_path($vo); ?>" src="<?php echo get_thumb($vo); ?>" width="100">
            </div>
            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
        </div>
            ...
            <div class="block-content tab-content block-group">
                ...
                <div class="tab-pane row <?php if($items_key == '1'): ?>active<?php endif; ?>" id="tab-<?php echo $items_key; ?>" >
                    <?php if(is_array($items) || $items instanceof \think\Collection || $items instanceof \think\Paginator): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form_group): $mod = ($i % 2 );++$i;switch($form_group['type']): case "archive": ?>
                                ...
                                <div class="form-group col-lg-<?php echo (isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12'); ?> <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" id="form_group_<?php echo $form_group['name']; ?>">
    ...
    <div class="col-sm-12">
        <ul class="list-group uploader-list" id="file_list_<?php echo $form_group['name']; ?>">
            ...
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo get_file_name($form_group['value']); ?> [<a
                    href="<?php echo get_file_path($form_group['value']); ?>" class="download-file">下载</a>]</li>
            <?php endif; ?>
        </ul>
    ...
    <div class="col-sm-12">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "bmap": ?>
                                ...
                                <div class="form-group col-lg-<?php echo (isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12'); ?> js-bmap <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" data-level="<?php echo $form_group['level']==''?12 : $form_group['level']; ?>" id="form_group_<?php echo $form_group['name']; ?>">
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-sm-12">
...
<script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=<?php echo (isset($form_group['ak']) && ($form_group['ak'] !== '')?$form_group['ak']:''); ?>"></script>
                            <?php break; case "button": ?>
                                
                                <div class="form-group col-lg-<?php echo (isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12'); ?>" id="form_group_<?php echo $form_group['name']; ?>">
    <div class="col-xs-12 form-btn-parent">
    ...
    <div class="col-md-12">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "daterange": ?>
                                ...
                                <div class="form-group col-lg-<?php echo (isset($_layout[$form_group['name_from']]['lg']) && ($_layout[$form_group['name_from']]['lg'] !== '')?$_layout[$form_group['name_from']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form_group['name_from']]['md']) && ($_layout[$form_group['name_from']]['md'] !== '')?$_layout[$form_group['name_from']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form_group['name_from']]['sm']) && ($_layout[$form_group['name_from']]['sm'] !== '')?$_layout[$form_group['name_from']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form_group['name_from']]['xs']) && ($_layout[$form_group['name_from']]['xs'] !== '')?$_layout[$form_group['name_from']]['xs']:'12'); ?> <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" id="form_group_<?php echo $form_group['id']; ?>">
    <label class="col-xs-12"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-md-12">
...
<div class="form-group col-lg-<?php echo (isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12'); ?> <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" id="form_group_<?php echo $form_group['name']; ?>">
    ...
    <div class="col-sm-12 js-upload-file">
        <ul class="list-group uploader-list" id="file_list_<?php echo $form_group['name']; ?>">
            <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): ?>
            <li class="list-group-item file-item"><i class="fa fa-file"></i> <?php echo get_file_name($form_group['value']); ?> [<a
                    href="<?php echo get_file_path($form_group['value']); ?>" class="download-file">下载</a>] [<a
                    href="javascript:void(0);" class="remove-file">删除</a>]</li>
            <?php endif; ?>
        </ul>
    ...
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-xs-12">
        <div id="file_list_<?php echo $form_group['name']; ?>" class="gallery-list">
            <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): if(is_array(explode(',',$form_group['value'])) || explode(',',$form_group['value']) instanceof \think\Collection || explode(',',$form_group['value']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$form_group['value']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="file-item thumbnail">
                <img data-original="<?php echo get_file_path($vo); ?>" src="<?php echo get_thumb($vo); ?>" width="100">
            </div>
    ...
    <div class="col-xs-12 js-upload-image">
        <div id="file_list_<?php echo $form_group['name']; ?>" class="uploader-list">
            <?php if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): ?>
            <div class="file-item thumbnail">
                <img data-original="<?php echo get_file_path($form_group['value']); ?>" src="<?php echo get_thumb($form_group['value']); ?>" width="100">
                <i class="fa fa-times-circle remove-picture"></i>
            </div>
            <?php endif; ?>
        </div>
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo $form_group['name']; ?>" data-multiple="false" data-watermark='<?php echo (isset($form_group["watermark"]) && ($form_group["watermark"] !== '')?$form_group["watermark"]:""); ?>' data-thumb='<?php echo (isset($form_group["thumb"]) && ($form_group["thumb"] !== '')?$form_group["thumb"]:""); ?>' data-size="<?php echo (isset($form_group['size']) && ($form_group['size'] !== '')?$form_group['size']:0); ?>" data-ext='<?php echo (isset($form_group["ext"]) && ($form_group["ext"] !== '')?$form_group["ext"]:""); ?>' id="<?php echo $form_group['name']; ?>" value="<?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?>">
    ...
    <div class="col-xs-12 js-upload-images">
        ...
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo $form_group['name']; ?>" data-multiple="true" data-watermark='<?php echo (isset($form_group["watermark"]) && ($form_group["watermark"] !== '')?$form_group["watermark"]:""); ?>' data-thumb='<?php echo (isset($form_group["thumb"]) && ($form_group["thumb"] !== '')?$form_group["thumb"]:""); ?>' data-size="<?php echo (isset($form_group['size']) && ($form_group['size'] !== '')?$form_group['size']:0); ?>" data-ext='<?php echo (isset($form_group["ext"]) && ($form_group["ext"] !== '')?$form_group["ext"]:""); ?>' id="<?php echo $form_group['name']; ?>" value="<?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?>">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "jcrop": ?>
                                ...
                                <div class="form-group col-lg-<?php echo (isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12'); ?> js-jcrop-interface <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" id="form_group_<?php echo $form_group['name']; ?>">
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-sm-12 uploader-list">
            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent remove-margin-b">
                    ...
                    <div class="block-content push-20">
                        ...
                        <div class="jcrop-img">
                            <img src="<?php echo get_file_path($form_group['value']); ?>" data-id="<?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?>" data-watermark='<?php echo (isset($form_group["watermark"]) && ($form_group["watermark"] !== '')?$form_group["watermark"]:""); ?>' data-thumb='<?php echo (isset($form_group["thumb"]) && ($form_group["thumb"] !== '')?$form_group["thumb"]:""); ?>' data-options='<?php echo (isset($form_group['options']) && ($form_group['options'] !== '')?$form_group['options']:""); ?>' class="js-jcrop" style="display: none;" alt="">
                        </div>
                    </div>
                </div>
...
<div class="form-group col-lg-<?php echo (isset($_layout[$form_group['name']]['lg']) && ($_layout[$form_group['name']]['lg'] !== '')?$_layout[$form_group['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form_group['name']]['md']) && ($_layout[$form_group['name']]['md'] !== '')?$_layout[$form_group['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form_group['name']]['sm']) && ($_layout[$form_group['name']]['sm'] !== '')?$_layout[$form_group['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form_group['name']]['xs']) && ($_layout[$form_group['name']]['xs'] !== '')?$_layout[$form_group['name']]['xs']:'12'); ?>" id="form_group_<?php echo $form_group['name']; ?>">
    ...
    <div class="col-xs-12 js-upload-image">
        <div id="file_list_<?php echo $form['name']; ?>" class="uploader-list">
            <?php if(!(empty($form['value']) || (($form['value'] instanceof \think\Collection || $form['value'] instanceof \think\Paginator ) && $form['value']->isEmpty()))): ?>
            <div class="file-item thumbnail">
                <img data-original="<?php echo get_file_path($form['value']); ?>" src="<?php echo get_thumb($form['value']); ?>" width="100">
                <i class="fa fa-times-circle remove-picture"></i>
            </div>
            <?php endif; ?>
        </div>
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo $form['name']; ?>" data-multiple="false" data-watermark='<?php echo (isset($form["watermark"]) && ($form["watermark"] !== '')?$form["watermark"]:""); ?>' data-thumb='<?php echo (isset($form["thumb"]) && ($form["thumb"] !== '')?$form["thumb"]:""); ?>' data-size="<?php echo (isset($form['size']) && ($form['size'] !== '')?$form['size']:0); ?>" data-ext='<?php echo (isset($form["ext"]) && ($form["ext"] !== '')?$form["ext"]:""); ?>' id="<?php echo $form['name']; ?>" value="<?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?>">
    ...
    <div class="col-xs-12 js-upload-images">
        ...
        <div class="clearfix"></div>
        <input type="hidden" name="<?php echo $form['name']; ?>" data-multiple="true" data-watermark='<?php echo (isset($form["watermark"]) && ($form["watermark"] !== '')?$form["watermark"]:""); ?>' data-thumb='<?php echo (isset($form["thumb"]) && ($form["thumb"] !== '')?$form["thumb"]:""); ?>' data-size="<?php echo (isset($form['size']) && ($form['size'] !== '')?$form['size']:0); ?>" data-ext='<?php echo (isset($form["ext"]) && ($form["ext"] !== '')?$form["ext"]:""); ?>' id="<?php echo $form['name']; ?>" value="<?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?>">
        ...
        <?php endif; ?>
                                            ...
                                            <?php break; case "jcrop": ?>
                                                ...
                                                <div class="form-group col-lg-<?php echo (isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12'); ?> js-jcrop-interface <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" id="form_group_<?php echo $form['name']; ?>">
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12 uploader-list">
            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent remove-margin-b">
                    ...
                    <div class="block-content push-20">
                        ...
                        <div class="jcrop-img">
                            <img src="<?php echo get_file_path($form['value']); ?>" data-id="<?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?>" data-watermark='<?php echo (isset($form["watermark"]) && ($form["watermark"] !== '')?$form["watermark"]:""); ?>' data-thumb='<?php echo (isset($form["thumb"]) && ($form["thumb"] !== '')?$form["thumb"]:""); ?>' data-options='<?php echo (isset($form['options']) && ($form['options'] !== '')?$form['options']:""); ?>' class="js-jcrop" style="display: none;" alt="">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<div class="form-group col-lg-<?php echo (isset($_layout[$form['name']]['lg']) && ($_layout[$form['name']]['lg'] !== '')?$_layout[$form['name']]['lg']:'12'); ?> col-md-<?php echo (isset($_layout[$form['name']]['md']) && ($_layout[$form['name']]['md'] !== '')?$_layout[$form['name']]['md']:'12'); ?> col-sm-<?php echo (isset($_layout[$form['name']]['sm']) && ($_layout[$form['name']]['sm'] !== '')?$_layout[$form['name']]['sm']:'12'); ?> col-xs-<?php echo (isset($_layout[$form['name']]['xs']) && ($_layout[$form['name']]['xs'] !== '')?$_layout[$form['name']]['xs']:'12'); ?>" id="form_group_<?php echo $form['name']; ?>">
    ...
    <div id="icon_tab" style="display:none">
        ...
        <ul  class="nav nav-tabs nav-simple">
            ...
            <li>
                <a href="#icon<?php echo $icon['id']; ?>" data-toggle="tab"><?php echo $icon['name']; ?></a>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <div class="tab-content js-icon-content" style="padding: 10px">
            ...
            <?php if(is_array($_icons) || $_icons instanceof \think\Collection || $_icons instanceof \think\Paginator): $i = 0; $__LIST__ = $_icons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$icon): $mod = ($i % 2 );++$i;?>
            <div class="tab-pane fade" id="icon<?php echo $icon['id']; ?>">
...
<!--页面js-->
    ...
    <script src="<?php echo $vo; ?>?v=<?php echo config('asset_version'); ?>"></script>
    <?php endforeach; endif; else: echo "" ;endif; if(is_array($extend_js_list) || $extend_js_list instanceof \think\Collection || $extend_js_list instanceof \think\Paginator): $i = 0; $__LIST__ = $extend_js_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        <script src="<?php echo $v; ?>?v=<?php echo config('asset_version'); ?>"></script>
        <?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
